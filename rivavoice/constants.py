...
CONFIG_INCLUDE_NON_SPEECH = (
    "include_non_speech"  # Note: Only relevant for ElevenLabs currently
)
...
# --- macOS Specific ---
MACOS_PRIVACY_URL_INPUT_MONITORING = (
    "x-apple.systempreferences:com.apple.preference.security?Privacy_ListenEvent"
)
MACOS_PRIVACY_URL_MICROPHONE = (
    "x-apple.systempreferences:com.apple.preference.security?Privacy_Microphone"
)
MACOS_PRIVACY_URL_GENERAL = (
